...
`cynork` operates against the User API Gateway for authentication, task operations, chat, and the currently implemented admin/resource surfaces.
Longer-term it is expected to reach administrative parity with the Web Console; see [cynork CLI spec](../docs/tech_specs/cynork_cli.md).
