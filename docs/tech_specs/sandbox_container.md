...
- [Node-Local Inference Access](#node-local-inference-access)
  ...
  - [Node-Local Inference Requirement Traces](#node-local-inference-requirement-traces)
  - [Unified UDS Approach (Required)](#unified-uds-approach-required)
...
### Node-Local Inference Requirement Traces
...
See [`docs/tech_specs/worker_node.md`](worker_node.md#spec-cynai-worker-unifiedudspath) and [Node-Local Inference](worker_node.md#spec-cynai-worker-nodelocalinference), and [`docs/tech_specs/ports_and_endpoints.md`](ports_and_endpoints.md#spec-cynai-stands-inferenceollamaandproxy).
