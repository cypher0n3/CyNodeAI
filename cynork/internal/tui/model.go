...
func (m *Model) applyStreamDelta(msg *streamDeltaMsg) (tea.Model, tea.Cmd) {
	...
	switch {
	case msg.amendment != "":
		m.applyStreamDeltaAmendment(msg)
	case msg.thinking != "":
	...
	case msg.iterationStart:
		return m.applyStreamDeltaIterationStart(msg)
	default:
		m.applyStreamDeltaTextDelta(msg)
	}
...
func (m *Model) applyStreamDeltaAmendment(msg *streamDeltaMsg) {
...
func (m *Model) applyStreamDeltaIterationStart(msg *streamDeltaMsg) (tea.Model, tea.Cmd) {
...
func (m *Model) applyStreamDeltaTextDelta(msg *streamDeltaMsg) {
