...
- Replacing `cynork status` or a future gateway-backed detailed health endpoint (see [`status_command_detailed_health_spec_proposal.md`](status_command_detailed_health_spec_proposal.md)): `stack ps` is **local topology**, not **application health** or **authorized node registry** state.
...
- [`docs/draft_specs/status_command_detailed_health_spec_proposal.md`](status_command_detailed_health_spec_proposal.md)
