...
- Draft spec (example pattern): [docs/draft_specs/mcp_tool_def.md](../draft_specs/mcp_tool_def.md) (GORM wrappers, GormModelUUID, MCPToolDefinitionRecord).
...
- [docs/draft_specs/mcp_tool_def.md](../draft_specs/mcp_tool_def.md) (GormModelUUID, record embedding pattern).
...
- [docs/draft_specs/mcp_tool_def.md](../draft_specs/mcp_tool_def.md) (MCPTool, MCPToolDefinitionRecord).
