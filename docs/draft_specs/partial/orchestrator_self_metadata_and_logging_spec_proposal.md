...
- **`components`** (optional): High-level component health summary (e.g. control-plane ready, PMA status, worker node count, artifact backend reachable).
  This MAY align with the detailed status shape in [012_status_command_detailed_health_spec_proposal.md](../012_status_command_detailed_health_spec_proposal.md) without duplicating it here.
...
- An extension to the control-plane or User API Gateway detailed status endpoint (e.g. `GET /v1/status` or equivalent as in [012_status_command_detailed_health_spec_proposal.md](../012_status_command_detailed_health_spec_proposal.md)), with a subsection or query parameter for self-metadata, or
...
**Traces To:** [REQ-ORCHES-0120](../../requirements/orches.md#req-orches-0120), [012_status_command_detailed_health_spec_proposal.md](../012_status_command_detailed_health_spec_proposal.md).
...
- [Status command detailed health (proposal)](../012_status_command_detailed_health_spec_proposal.md)
