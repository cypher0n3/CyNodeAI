...
func TestMockDB_GetUserByHandleNotFound(t *testing.T) {
        db := NewMockDB()
        ctx := context.Background()

        _, err := db.GetUserByHandle(ctx, "nonexistent")
...
func TestMockDB_GetUserByIDNotFound(t *testing.T) {
        db := NewMockDB()
        ctx := context.Background()
...
func TestMockDB_GetPasswordCredentialNotFound(t *testing.T) {
        db := NewMockDB()
        ctx := context.Background()
...
func TestMockDB_GetTaskByIDNotFound(t *testing.T) {
        db := NewMockDB()
        ctx := context.Background()
...
func TestMockDB_GetNodeBySlugNotFound(t *testing.T) {
        db := NewMockDB()
        ctx := context.Background()

        _, err := db.GetNodeBySlug(ctx, "nonexistent")
        if !errors.Is(err, database.ErrNotFound) {
                t.Errorf("expected ErrNotFound, got %v", err)
        }
}
