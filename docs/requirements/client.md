...
- **REQ-CLIENT-0001:** CLI: no direct DB; gateway for all ops; no secrets in output or on disk; token auth; least privilege.
  [CYNAI.CLIENT.Doc.CliManagementApp](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-doc-climanagementapp)
  [CYNAI.CLIENT.CliSecurityModel](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clisecurity)
  [CYNAI.CLIENT.CliAuthConfig](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-cliauth)
...
- **REQ-CLIENT-0004:** The Web Console and the CLI management app MUST provide capability parity for administrative operations.
  ...
  [CYNAI.CLIENT.CliCapabilityParity](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clicapabilityparity)
...
- **REQ-CLIENT-0103:** The CLI MUST not persist plaintext secrets to disk.
  [CYNAI.CLIENT.CliSecurityModel](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clisecurity)
  [CYNAI.CLIENT.CliConfigFileLocation](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-cliconfigfilelocation)
  [CYNAI.CLIENT.CliCredentialHelperProtocol](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clicredentialhelperprotocol)
...
- **REQ-CLIENT-0105:** The CLI MUST support token-based authentication.
  [CYNAI.CLIENT.CliAuthConfig](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-cliauth)
  [CYNAI.CLIENT.CliTokenResolution](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clitokenresolution)
...
- **REQ-CLIENT-0116:** Credential create MUST accept secrets only on create or rotate operations.
  ...
  [CYNAI.CLIENT.CliCredentialManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-clicredential)
...
- **REQ-CLIENT-0121:** Preference edits MUST be scoped and versioned.
  ...
  [CYNAI.CLIENT.CliPreferencesManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-clipreferences)
...
- **REQ-CLIENT-0125:** Node management MUST be mediated by the User API Gateway.
  ...
  [CYNAI.CLIENT.CliNodeManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-clinodemgmt)
...
- **REQ-CLIENT-0136:** The interactive CLI mode MUST provide access to the same commands and flags as the non-interactive CLI.
  [CYNAI.CLIENT.CliInteractiveMode](../tech_specs/cynork/cli_management_app_shell_output.md#spec-cynai-client-cliinteractivemode)
...
- **REQ-CLIENT-0143:** The CLI MUST support JSON output mode.
  [CYNAI.CLIENT.CliOutputScripting](../tech_specs/cynork/cli_management_app_shell_output.md#spec-cynai-client-clioutputscripting)
...
- **REQ-CLIENT-0146:** The CLI MUST support full CRUD for skills (create/load, list, get, update, delete) via the User API Gateway, with the same controls as defined in the skills spec (scope visibility, scope elevation permission, auditing on write).
  ...
  [CYNAI.CLIENT.CliSkillsManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-cliskillsmanagement)
...
- **REQ-CLIENT-0149:** The CLI MUST NOT persist plaintext gateway tokens or session credentials in the user config directory or in `config.yaml`.
  ...
  **Exception:** session tokens MAY be stored outside the config directory using the OS credential store or, when that is unavailable, a dedicated file under the XDG cache directory (see [CYNAI.CLIENT.CliSessionPersistence](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clisessionpersistence)).
...
- **REQ-CLIENT-0150:** The CLI MUST resolve the config file path for non-secret preferences consistently (e.g. honoring XDG_CONFIG_HOME).
  ...
  [CYNAI.CLIENT.CliConfigFileLocation](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-cliconfigfilelocation)
  [CYNAI.CLIENT.CliSessionPersistence](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clisessionpersistence)
...
- **REQ-CLIENT-0155:** The CLI command surface for tasks MUST be fully specified and MUST be treated as a stable user-facing contract.
  ...
  [CYNAI.CLIENT.CliCommandSurface](../tech_specs/cynork/cynork_cli.md#spec-cynai-client-clicommandsurface)
...
- **REQ-CLIENT-0160:** The Web Console and the CLI MUST allow configuring Project Manager model selection for local inference via system settings.
  ...
  [CYNAI.CLIENT.CliSystemSettingsManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-clisystemsettings)
...
- **REQ-CLIENT-0161:** The CLI MUST provide a single interactive cynork chat surface for chatting with the Project Manager (PM) model.
  ...
  [CYNAI.CLIENT.CliChat](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichat)
  [CYNAI.CLIENT.CynorkTui.EntryPoint](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui-entrypoint)
...
- **REQ-CLIENT-0162:** The interactive cynork chat surface MUST render model responses with pretty-formatted output when the response contains Markdown.
  ...
  [CYNAI.CLIENT.CliChat](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichat)
  [CYNAI.CLIENT.CynorkChat.TUILayout](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-tuilayout)
...
- **REQ-CLIENT-0163:** The CLI MUST display all JSON as pretty-printed (indented, with newlines) whenever JSON is part of the output.
  ...
  [CYNAI.CLIENT.CliPrettyPrintJson](../tech_specs/cynork/cli_management_app_shell_output.md#spec-cynai-client-cliprettyprintjson)
...
- **REQ-CLIENT-0164:** The interactive cynork chat surface MUST display the available slash commands (e.g. `/exit`, `/quit`, `/help`) to the user.
  ...
  [CYNAI.CLIENT.CliChatSlashCommands](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashcommands)
  [CYNAI.CLIENT.CynorkTui.LocalSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-localslashcommands)
...
- **REQ-CLIENT-0165:** The interactive cynork chat surface MUST support slash-command autocomplete and inline suggestions when the user types `/`.
  ...
  [CYNAI.CLIENT.CliChatSlashAutocomplete](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashautocomplete)
...
- **REQ-CLIENT-0166:** The interactive cynork chat surface MUST support task operations via slash commands: list, get, create (with inline prompt), cancel, result, logs, and artifacts list.
  ...
  [CYNAI.CLIENT.CliChatSlashTask](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashtask)
  [CYNAI.CLIENT.CynorkTui.TaskSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-taskslashcommands)
...
- **REQ-CLIENT-0167:** The interactive cynork chat surface MUST support `/status` and `/whoami` slash commands to show gateway reachability and current identity without leaving chat.
  [CYNAI.CLIENT.CliChatSlashStatus](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashstatus)
  [CYNAI.CLIENT.CynorkTui.StatusSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-statusslashcommands)
...
- **REQ-CLIENT-0168:** The interactive cynork chat surface MUST support node listing and get via slash commands: `/nodes list`, `/nodes get <node_id>`.
  [CYNAI.CLIENT.CliChatSlashNodes](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashnodes)
  [CYNAI.CLIENT.CynorkTui.NodeSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-nodeslashcommands)
...
- **REQ-CLIENT-0169:** The interactive cynork chat surface MUST support preferences via slash commands: list, get, set, delete, and effective (e.g. `/prefs list`, `/prefs get [key]`, `/prefs set ...`, `/prefs delete ...`, `/prefs effective [--task-id <id>]`).
  [CYNAI.CLIENT.CliChatSlashPrefs](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashprefs)
  [CYNAI.CLIENT.CynorkTui.PreferenceSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-preferenceslashcommands)
...
- **REQ-CLIENT-0170:** The interactive cynork chat surface MUST support full skills CRUD via slash commands: `/skills list`, `/skills get <skill_selector>`, `/skills load <file.md>`, `/skills update <skill_selector> <file.md>`, and `/skills delete <skill_selector>`.
  ...
  [CYNAI.CLIENT.CliChatSlashSkills](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashskills)
  [CYNAI.CLIENT.CynorkTui.SkillSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-skillslashcommands)
...
- **REQ-CLIENT-0171:** The interactive cynork chat surface MUST support selecting an OpenAI model identifier for chat completions.
  ...
  [CYNAI.CLIENT.CliChatModelSelection](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatmodelselection)
  [CYNAI.CLIENT.CynorkTui.ModelSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-modelslashcommands)
...
- **REQ-CLIENT-0173:** The interactive cynork chat surface MUST support setting an optional project context for the chat session.
  ...
  [CYNAI.CLIENT.CliChatProjectContext](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatprojectcontext)
  [CYNAI.CLIENT.CynorkTui.ProjectSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-projectslashcommands)
  [CYNAI.ACCESS.Doc.ProjectsAndScopes](../tech_specs/projects_and_scopes.md#spec-cynai-access-doc-projectsandscopes)
...
- **REQ-CLIENT-0174:** The CLI and the Web Console MUST support basic project management (CRUD: create, list, get, update, delete or disable) via the User API Gateway.
  ...
  [CYNAI.CLIENT.CliProjectManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-cliprojectmanagement)
...
- **REQ-CLIENT-0175:** The interactive cynork chat surface MUST support a shell-escape syntax: input starting with `!` runs the remainder of the line as a shell command; the command's output is displayed inline and the chat session continues.
  [CYNAI.CLIENT.CliChatShellEscape](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatshellescape)
...
- **REQ-CLIENT-0176:** When a slash command or shell-escape command fails in the interactive cynork chat surface (e.g. gateway 404, command not found), the CLI MUST display the error and MUST NOT exit the chat session or show the top-level command Usage.
  [CYNAI.CLIENT.CliChatSubcommandErrors](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatsubcommanderrors)
...
- **REQ-CLIENT-0177:** Clients that provide an interactive chat session (e.g. CLI chat command, Web Console chat UI) SHOULD call the gateway chat warm-up endpoint after auth and before the first user prompt when the gateway exposes it.
  ...
  [CYNAI.CLIENT.CliChatWarmUp](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatwarmup)
...
- **REQ-CLIENT-0178:** The CLI chat command MUST support a one-shot mode: when invoked with `-m, --message <text>`, the CLI MUST send that single message to the gateway via the configured OpenAI-compatible interactive chat surface, print the completion content (subject to `--plain` and `--no-color`), and exit.
  ...
  [CYNAI.CLIENT.CliChatOneShot](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatoneshot)
...
- **REQ-CLIENT-0179:** The Web Console and the CLI MUST support full CRUD for Agent personas (create, list, get, update, delete) via the User API Gateway, with capability parity between both clients.
  ...
  [CYNAI.CLIENT.CliPersonasManagement](../tech_specs/cynork/cli_management_app_commands_admin.md#spec-cynai-client-clipersonasmanagement)
...
- **REQ-CLIENT-0181:** The interactive cynork chat surface MUST start each session with a **new thread by default**.
  ...
  [CYNAI.CLIENT.CliChatThreadControls](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatthreadcontrols)
  [CYNAI.CLIENT.CynorkTui.ThreadSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-threadslashcommands)
...
- **REQ-CLIENT-0182:** Clients with a rich chat UI MUST prefer the structured chat-turn representation when the gateway provides it and MUST fall back to canonical plain-text transcript content when it does not.
  [CYNAI.CLIENT.CynorkTui.TranscriptRendering](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui-transcriptrendering)
  [CYNAI.CLIENT.CliChatResponseOutput](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatresponseoutput)
...
- **REQ-CLIENT-0183:** Clients with a rich chat UI MUST NOT render model thinking or reasoning content as normal assistant transcript text by default.
  ...
  [CYNAI.CLIENT.CynorkTui.ThinkingVisibilityBehavior](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-thinkingvisibilitybehavior)
  [CYNAI.CLIENT.CynorkTui.TranscriptRendering](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui-transcriptrendering)
  [CYNAI.CLIENT.CliChatResponseOutput](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatresponseoutput)
...
- **REQ-CLIENT-0185:** Interactive chat UIs SHOULD update the in-flight assistant turn progressively when the gateway or provider exposes streaming or incremental output.
  ...
  [CYNAI.CLIENT.CynorkTui.GenerationState](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui-generationstate)
...
- **REQ-CLIENT-0187:** The interactive cynork chat surface MAY persist local configuration for UI preferences such as default model, composer mode, context-pane visibility, and keybinding overrides.
  ...
  [CYNAI.CLIENT.CynorkChat.LocalConfig](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-localconfig)
...
- **REQ-CLIENT-0188:** The interactive cynork chat surface MAY use a local cache for completion and list data such as task identifiers, project identifiers, model identifiers, and thread-list metadata.
  ...
  [CYNAI.CLIENT.CynorkChat.LocalCache](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-localcache)
...
- **REQ-CLIENT-0190:** `cynork tui` MUST start and render the TUI surface unconditionally, without requiring a valid login token at launch.
  ...
  [CYNAI.CLIENT.CynorkChat.AuthRecovery](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-authrecovery)
...
- **REQ-CLIENT-0191:** The CLI SHOULD support a web-based login flow suitable for SSO-capable deployments in addition to username/password login.
  ...
  [CYNAI.CLIENT.CliWebLogin](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cliweblogin)
...
- **REQ-CLIENT-0198:** Chat UIs MAY support an `@` shorthand in the composer for referencing local files.
  ...
  [CYNAI.CLIENT.CynorkChat.AtFileReferences](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-atfilereferences)
...
- **REQ-CLIENT-0203:** The interactive cynork chat surface SHOULD provide a cursor-agent-like experience with a multi-line composer, scrollback, search and copy behavior, a persistent status bar, an optional context pane, message-history recall, structured-turn rendering, and completion for relevant chat actions.
  ...
  [CYNAI.CLIENT.CynorkChat.TUILayout](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-tuilayout)
  [CYNAI.CLIENT.CynorkChat.Completion](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-completion)
  [CYNAI.CLIENT.CynorkTui.LocalSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktui-localslashcommands)
...
- **REQ-CLIENT-0207:** Slash commands in interactive chat MUST provide parity with the previously available shell command surface for tasks, status, identity, nodes, preferences, skills, model, project, and thread controls.
  ...
  [CYNAI.CLIENT.CliChatSlashCommandReference](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatslashcommandreference)
  [CYNAI.CLIENT.CynorkTuiSlashCommands](../tech_specs/cynork/cynork_tui_slash_commands.md#spec-cynai-client-cynorktuislashcommands)
  [CYNAI.CLIENT.CliChatShellEscape](../tech_specs/cynork/cli_management_app_commands_chat.md#spec-cynai-client-clichatshellescape)
  [CYNAI.CLIENT.CynorkChat.TUILayout](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorkchat-tuilayout)
...
- **REQ-CLIENT-0212:** The TUI MUST display the current thread title (or a fallback label) and MUST update the displayed thread title whenever it changes (e.g. after auto-title or `/thread rename`) and when the user switches to a different thread.
  [CYNAI.CLIENT.CynorkTui](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui)
...
- **REQ-CLIENT-0213:** When the connection to the gateway is interrupted mid-stream (e.g. network drop, gateway restart), the interactive cynork chat surface MUST attempt to auto-reconnect with bounded backoff.
  ...
  [CYNAI.CLIENT.CynorkTui.ConnectionRecovery](../tech_specs/cynork/cynork_tui.md#spec-cynai-client-cynorktui-connectionrecovery)
