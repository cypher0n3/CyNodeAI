...
If the draft model-routing document at [`docs/draft_specs/006_llm_routing_and_model_handling_spec_draft.md`](../006_llm_routing_and_model_handling_spec_draft.md) is later promoted, it may include a short cross-reference note.
