...
- [User-Installable MCP Tools](../../tech_specs/mcp/user_installable_mcp_tools.md): registration of tools; tool definitions reference endpoints by the keys defined here.
...
- [MCP Gateway Enforcement](../../tech_specs/mcp/mcp_gateway_enforcement.md): tool call enforcement; resolution runs before the gateway forwards the call.
