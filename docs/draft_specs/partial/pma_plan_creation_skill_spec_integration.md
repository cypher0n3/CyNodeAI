...
- Drafts: `2026-03-13_pma_plan_drafting_improvements_proposal.md` (doc removed; dependency-only execution, task refs by name, optional YAML frontmatter, runnability/parallelism), [integrated/task_routing_pma_first_task_state.md](../integrated/task_routing_pma_first_task_state.md).
