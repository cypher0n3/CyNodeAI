...
Direct tool names MUST match tools offered by that server (or the [MCP tool specifications](../tech_specs/mcp_tools/README.md) when `Server` is `default`); argument keys and types follow the catalog and [common argument requirements](../tech_specs/mcp_tooling.md#spec-cynai-mcptoo-commonargumentrequirements).
...
- **External**: User-installed or remote MCP tools; registered via [User-Installable MCP Tools](../tech_specs/user_installable_mcp_tools.md); `Server` is an API endpoint registered with the API gateway.
...
- [MCP tooling](../tech_specs/mcp_tooling.md)
- [MCP gateway enforcement](../tech_specs/mcp_gateway_enforcement.md)
...
- User-installed external tools follow the same scope model; see [User-Installable MCP Tools](../tech_specs/user_installable_mcp_tools.md).
