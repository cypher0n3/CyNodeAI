...
Scenario: Set a system setting
  Given I am logged in with username "alice" and password "secret"
  When I run cynork settings set key "agents.pm.model" value "\"qwen3.5:0.8b\""
  Then cynork exits with code 0

@req_client_0160
@spec_cynai_client_clisystemsettings
Scenario: Get a system setting
  Given I am logged in with username "alice" and password "secret"
  When I run cynork settings get key "agents.pm.model"
  Then cynork exits with code 0
