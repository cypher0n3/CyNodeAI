...
func TestCallGenerate_SingleJSON(t *testing.T) {
	...
	out, err := CallGenerate(ctx, nil, server.URL, "qwen3.5:0.8b", "Hi")
	if err != nil {
...
func TestCallGenerate_ErrorResponse(t *testing.T) {
	...
	ctx := context.Background()
	_, err := CallGenerate(ctx, nil, server.URL, "qwen3.5:0.8b", "Hi")
	if err == nil {
...
func TestCallGenerate_EmptyURL(t *testing.T) {
	ctx := context.Background()
	_, err := CallGenerate(ctx, nil, "", "qwen3.5:0.8b", "Hi")
	if err == nil {
