...
func processChatSSEDataLine(data, lastEvent string, onDelta, onAmendment, onResponseID func(string), extra *StreamExtra) (streamDone bool, err error) {
	...
	case userapi.SSEEventThinkingDelta:
		sseDispatchThinkingDelta(data, extra)
		return false, nil
	case userapi.SSEEventToolCall:
		sseDispatchToolCall(data, extra)
		return false, nil
	case userapi.SSEEventHeartbeat:
		sseDispatchHeartbeat(data, extra)
		return false, nil
	case userapi.SSEEventIterationStart:
		sseDispatchIterationStart(data, extra)
		return false, nil
	}
...
func sseDispatchThinkingDelta(data string, extra *StreamExtra) {
...
func sseDispatchToolCall(data string, extra *StreamExtra) {
...
func sseDispatchHeartbeat(data string, extra *StreamExtra) {
...
func sseDispatchIterationStart(data string, extra *StreamExtra) {
