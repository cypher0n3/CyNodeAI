...
- [2 `GoSqlGorm` Rule](#2-gosqlgorm-rule)
  - [2.1 `GoSqlGorm` Scope](#21-gosqlgorm-scope)
  - [2.2 `GoSqlGorm` Preconditions](#22-gosqlgorm-preconditions)
  - [2.3 `GoSqlGorm` Outcomes](#23-gosqlgorm-outcomes)
  - [2.4 `GoSqlGorm` Error Conditions](#24-gosqlgorm-error-conditions)
- [3 Drivers and Backends](#3-drivers-and-backends)
- [4 Relationship to Other Specs](#4-relationship-to-other-specs)
...
### 2.4 `GoSqlGorm` Error Conditions
