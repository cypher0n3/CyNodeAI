...
- **MVP scope**: [mvp.md](mvp.md) - current minimum viable product scope and phase status.
- **MVP implementation plan**: [mvp_plan.md](mvp_plan.md) - detailed implementation status, completed work, and remaining MVP tasks.
...
- [draft_specs/](draft_specs/README.md) - proposals and archived superseded drafts: numbered priority queue at repo root under `draft_specs/`, plus `draft_specs/integrated/` and `draft_specs/partial/` (see README).
